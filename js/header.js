header = '<header>\
    <div class="container">\
        <div class="mob-header">\
            ...
            <a class="brand-logo" href="https://www.1111.com.tw/" title="1111 科技專區" target="_blank"><img src="images/logo01.png"></a>\
        </div>\
        <div class="sidebar-slide collapse collapse-horizontal" id="collapseWidthExample">\
            <ul class="nav">\
                ...
                <li class="nav-item"><a href="introduce.html" class="nav-link">論壇講座</a></li>\
                <li class="nav-item"><a href="techNewStars.html" class="nav-link">科技新秀</a></li>\
                ...
                <li class="nav-item"><a href="aboutTech.html" class="nav-link">關於我們</a></li>\
